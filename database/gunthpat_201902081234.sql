...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2019 at 05:33 AM
...
CREATE TABLE IF NOT EXISTS `tb_contact_head` (
...
CREATE TABLE IF NOT EXISTS `tb_contact_title` (
...
CREATE TABLE IF NOT EXISTS `tb_facilities_head` (
...
CREATE TABLE IF NOT EXISTS `tb_gallery_head` (
...
CREATE TABLE IF NOT EXISTS `tb_gallery_type` (
  `gallery_type_id` int(5) NOT NULL,
