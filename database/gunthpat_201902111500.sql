...
--
-- Host: localhost
-- Generation Time: Feb 11, 2019 at 08:00 AM
...
(2, '2', 'สมใจ', 'ใจดี', 'Test@gmail.com', '085-965-9587', 'ประเทศไทย', '', 'ใช้บริการแอร์พอร์ต ลิงก์ จากสนามบินนานาชาติสุวรรณภูมิมาที่พญาไทโดยให้บริการทุกๆ 20 นาทีตั้งแต่เวลา 6.00 น. ถึง 24.00 น. เที่ยงคืน โดยขึ้นรถไฟฟ้าบีทีเอส เปลี่ยนขบวนที่สถานีสยาม และลงที่สถานีสะพานตากสิน จากที่นั่น ท่านสามารถใช้บริการเรือโดยสารได้ฟรี โดยเรือออกทุก 20 นาที\r\nโปรดแจ้งให้ทางโรงแรมทราบล่วงหน้าเพื่อให้เราทราบถึงรูปแบบการเดินทางของท่าน'),
...
(4, '3', 'dasd', 'das', 'asd', 'asdas', 'AFG', '1', 'asdasdasdasdasd'),
(5, '3', 'dasd', 'das', 'asd', 'asdas', 'AFG', '1', 'asdasdasdasdasd'),
(6, '2', 'asd', 'asd', 'asd', 'sdasd', 'ARE', '2', '555'),
(7, '2', 'asd', 'asd', 'asd', 'sdasd', 'ARE', '2', '555'),
(8, '2', 'asd', 'asd', 'asd', 'sdasd', 'ARE', '2', '555'),
(9, '2', 'asd', 'asd', 'asd', 'sdasd', 'ARE', '2', '555'),
(10, '2', 'asd', 'asd', 'asd', 'asd', 'AND', '3', 'asdasdasdasdasd'),
(11, '1', 'asdasdas', 'sd', 'asd', 'asd', 'AND', '5', 'asdasdasdasd'),
(12, '1', 'asdasdas', 'sd', 'asd', 'asd', 'AND', '5', 'asdasdasdasd');
...
INSERT INTO `tb_contact_type` (`contact_type_id`, `contact_type_name`) VALUES
(1, 'สำคัญ'),
(2, 'ด่วนมาก'),
(3, 'ด่วน'),
(4, 'ปานกลาง'),
...
(10, '', '0902201901001909022019010019821357893.jpg', 1, 0),
(11, '', '0902201912275709022019122757501095111.jpg', 1, 0),
(12, '', '0902201912281309022019122813400796524.jpg', 1, 0);
...
(4, 4, 'Anantara Riverfront Suite', 't hotel urban hotel, sardinia A dynamic hotel with diversified amenities and activities, a vibrant approach to hospitality and ', '6100.00', 5, '004.jpg', '38 ตารางเมตร', 'ผู้ใหญ่ 2 ท่าน + เด็ก 1 ท่าน', 'ระเบียงส่วนตัว', 'วิวเมืองวิวสวน', 'บริการโทรศัพท์ห้อง', 'บริการ WiFi ฟรี', 0),
(5, 4, 'Dream Stateroom', 't hotel urban hotel, sardinia A dynamic hotel with diversified amenities and activities, a vibrant approach to hospitality and ', '12000.00', 5, '005.jpg', '38 ตารางเมตร', 'ผู้ใหญ่ 2 ท่าน + เด็ก 1 ท่าน', 'ระเบียงส่วนตัว', 'วิวเมืองหรือวสวน', 'บริการโทรศัพท์ห้อง', 'บริการ WiFi ฟรี', 0),
(6, 4, 'Family Suite', 't hotel urban hotel, sardinia A dynamic hotel with diversified amenities and activities, a vibrant approach to hospitality and ', '9800.00', 5, '006.jpg', '38 ตารางเมตร', 'ผู้ใหญ่ 2 ท่าน + เด็ก 1 ท่าน ', 'ระเบียงส่วนตัว', 'วิวเมืองหรือสวน', 'บริการโทรศัพท์ห้อง', 'บริการ WiFi ฟรี', 0);
...
(4, '110220191417071102201914170723148306.png', '000000', '0000000', '00');
...
--
ALTER TABLE `tb_gallery`
  MODIFY `gallery_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
