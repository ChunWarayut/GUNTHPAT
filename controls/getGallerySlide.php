...
<div class="gal-item">
    ...
    <div class="row">
        ...
        <div class="col-6 col-6 co-12 gal-item">
            <div class="box">
                <img src="<?PHP echo $path_img . $gallery[$i+3]['gallery_img']?>" class="img-ht img-fluid rounded"
                    onclick="Show('<?PHP echo $path_img . $gallery[$i+3]['gallery_img']?>');">
            </div>
        </div>
        <?PHP }  ?>
        ...
        <div class="col-6 col-6 co-12 gal-item">
            <div class="box">
                <img src="<?PHP echo $path_img . $gallery[$i+4]['gallery_img']?>" class="img-ht img-fluid rounded"
                    onclick="Show('<?PHP echo $path_img . $gallery[$i+4]['gallery_img']?>');">
            </div>
        </div>
        <?PHP }  ?>
        ...
        <div class="col-6 col-6 co-12 gal-item">
            <div class="box">
                <img src="<?PHP echo $path_img . $gallery[$i+5]['gallery_img']?>" class="img-ht img-fluid rounded"
                    onclick="Show('<?PHP echo $path_img . $gallery[$i+5]['gallery_img']?>');">
            </div>
        </div>
        <?PHP }  ?>
        <div class="col-6 col-6 co-12 gal-item">
                ...
                <div class="col-6 col-6 co-12 gal-item">
                    <div class="box">
                        <img src="<?PHP echo $path_img . $gallery[$i+6]['gallery_img']?>"
                            class="img-ht img-fluid rounded"
                            onclick="Show('<?PHP echo $path_img . $gallery[$i+6]['gallery_img']?>');">
                    </div>
                </div>
                <?PHP }  ?>
                ...
                <div class="col-6 col-6 co-12 gal-item">
                    <div class="box">
                        <img src="<?PHP echo $path_img . $gallery[$i+7]['gallery_img']?>"
                            class="img-ht img-fluid rounded"
                            onclick="Show('<?PHP echo $path_img . $gallery[$i+7]['gallery_img']?>');">
                    </div>
                </div>
                <?PHP }  ?>
                ...
                <div class="col-6 col-6 co-12 gal-item">
                    <div class="box">
                        <img src="<?PHP echo $path_img . $gallery[$i+8]['gallery_img']?>"
                            class="img-ht img-fluid rounded"
                            onclick="Show('<?PHP echo $path_img . $gallery[$i+8]['gallery_img']?>');">
                    </div>
                </div>
                <?PHP }  ?>
                ...
                <div class="col-6 col-6 co-12 gal-item">
                    <div class="box">
                        <img src="<?PHP echo $path_img . $gallery[$i+9]['gallery_img']?>"
                            class="img-ht img-fluid rounded"
                            onclick="Show('<?PHP echo $path_img . $gallery[$i+9]['gallery_img']?>');">
                    </div>
                </div>
                <?PHP }  ?>
            </div>
