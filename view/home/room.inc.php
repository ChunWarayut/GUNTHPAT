            ...
            <div class="room-detail-text">
                ...
                <div class="row">
                    <div class="col-12 justify-content-end d-flex align-items-center">
                        <span class="h4 m-0 mr-2"><?php echo $rooms[$i]['room_price_th']; ?> </span>
                        <a class="btn btn-orange" href="room.php?id=<?PHP echo $rooms[$i]['room_id']-1; ?>#detail">
    ...
    <div class="row">
        ...
        <div class="col-md-4 order-1 order-md-2 room-text">
            <div class="room-detail-text">
                ...
                <div class="row">
                    <div class="col-12 justify-content-end d-flex align-items-center">
                        <span class="h4 m-0 mr-2"><?php echo $rooms[$i]['room_price_th']; ?>
                        </span>
                            <a class="btn btn-orange" href="room.php?id=<?PHP echo $rooms[$i]['room_id']-1; ?>#detail">
                            <?php if ($lng == TH) {  echo "ดูเพิ่มเติม";   }else { echo "See More";  }  ?>
                        </a>
