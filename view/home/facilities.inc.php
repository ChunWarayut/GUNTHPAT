...
<section class="facilities" >
    ...
    <div class="facilities-slide-item" >
        <div class="facilities-detail d-flex align-items-center">
            <div class="row facilities-detail-form">
            <div class="col-lg-4 col-md-12 facilities-detail-titel  ">
                ...
                <div class="col-lg-5 col-md-8 facilities-detail-image">
                        <img src="<?php echo $pathImgFacilities.$facilities[$i]['facilities_img']; ?>" class="img-fluid">
                </div>
                <div class="col-lg-3 col-md-4 facilities-detail-flood">
                    <a class="btn">
                        <span class="h3"><span ><i class="fas fa-concierge-bell"></i></span></span>
                        <p>
