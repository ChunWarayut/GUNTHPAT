...
<div class="card">
    ...
    <div class="row">
        <div class="col-lg-6">
            <h1>
            หน้าแก้ไข  Recommended room <?PHP echo$id+1;?>
            </h1>
        </div>
        <div class="col-lg-6">
            ...
            <div class="row ">
                <div class="col-lg-3">
                    <div class="form-group" align="center">
                        ...
                        <input accept=".jpg , .png" type="file" id="recommend_img" name="recommend_img" class="form-control" style="margin: 14px 0 0 0 ;" onChange="readURL(this);" value="<?php echo  $recommend_rooms[$id]['recommend_img']; ?>">
                    </div>
                </div>
