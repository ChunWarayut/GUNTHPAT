...
<div class="row" style="overflow: scroll;">
    <?PHP for ($i=0; $i < count($gallery); $i++) { ?>
        <div class="col-md-3">
        <a class="btn-close p-0 img-close mr-2 mt-2" href="?content=rooms&action=delete_img&id=<?PHP echo  $gallery[$i]['gallery_id'];?>" ><i class="fa fa-times"></i></a>
