...
<form id="form_target" role="form" method="post" action="index.php?content=gallery&action=insert_type">
    <div class="card">
        ...
        <div class="card-body">
            <input type="hidden" id="gallery_type_id" name="gallery_type_id" value="" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="gallery_type_name_th" name="gallery_type_name_th" class="form-control" value="" />
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input id="gallery_type_name_en" name="gallery_type_name_en" class="form-control" value="" />
                                <p class="help-block">Example : Title </p>
                            </div>
                        </div>
