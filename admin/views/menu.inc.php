<div id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li><a href="index.php?content=home">
                <div <?php if($content=="" || $content=="home" ){echo "class='menu-active top'" ;} else {echo
                    "class='menu top'" ;}?> >
        ...
        <li><a href="index.php?content=about_us">
                <div <?php if($content=="about_us" || $content=="about_image" ){echo "class='menu-active'" ;} else
                    {echo "class='menu'" ;}?> >
        ...
        <li><a href="index.php?content=contact_us">
                <div <?php if($content=="contact_us" || $content=="about_image" ){echo "class='menu-active'" ;} else
                    {echo "class='menu'" ;}?> >
